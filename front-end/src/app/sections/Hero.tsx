...
import { HERO_FRAME_SHAPE, HERO_PHOTO_SRC, HERO_RESUME_SRC } from '../data/hero';
				...
				<div>
					...
					*/}
					...
					>
						...
						<a
							href={HERO_RESUME_SRC}
							target="_blank"
							rel="noopener noreferrer"
							className="px-7 py-3 font-medium inline-flex items-center gap-2 border border-text/20 text-text rounded-pill hover:border-accent hover:text-accent hover:-translate-y-0.5 transition-all"
						>
							<svg
